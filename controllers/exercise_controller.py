class ExerciseController:
    ...
    def get_exercise(self, exercise_id):
        return self.exercise_service.get_exercise(exercise_id)
    ...
    def search_exercise(self, query):
        return self.exercise_service.search_exercise(query)

    def count_exercise(self):
        return self.exercise_service.count_exercise()
    ...
    def get_exercises_by_teacher(self, teacher_id):
        return self.exercise_service.get_exercises_by_teacher(teacher_id)