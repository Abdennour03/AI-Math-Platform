class AttendanceController:
    ...
    def get_class_students(self, teacher_id, class_id):
        return self.attendance_service.get_class_students(teacher_id, class_id)

    def save_attendance(self, teacher_id, class_id, attendance_date, records):
        return self.attendance_service.save_attendance(
            teacher_id, class_id, attendance_date, records
        )

    def get_teacher_history(self, teacher_id, class_id=None, month=None):
        return self.attendance_service.get_teacher_history(teacher_id, class_id, month)

    def get_monthly_report(self, class_id, month):
        return self.attendance_service.get_monthly_report(class_id, month)
